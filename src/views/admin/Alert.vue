            ...
            <Card>
                ...
                <div>
                    ...
                    <DefaultAlertVue class="text-red-800 bg-red-50"> <span class="font-medium">Info alert!</span> Change a
                        few things up and try submitting again.</DefaultAlertVue>
                    <DefaultAlertVue class="text-green-800 bg-green-50"> <span class="font-medium">Info alert!</span> Change
                        a few things up and try submitting again.</DefaultAlertVue>
                    <DefaultAlertVue class="text-yellow-800 bg-yellow-50"> <span class="font-medium">Info alert!</span>
                        Change a few things up and try submitting again.</DefaultAlertVue>
                    <DefaultAlertVue class="text-gray-800 bg-gray-50"> <span class="font-medium">Info alert!</span> Change a
                        few things up and try submitting again.</DefaultAlertVue>
